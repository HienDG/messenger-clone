...
const AuthLayout: React.FC<React.PropsWithChildren> = async ({ children }) => {
   ...
   // if use session does exist , navigate to home page
   if (session) return redirect(HOME_URL);
         ...
         <section className="px-4 py-6 flex-1 max-w-7xl mx-auto w-full h-full">
            <header>
               <div className="flex  items-center gap-3">
                  <Image src="/assets/logo.png" alt="logo" width={100} height={100} className="w-10 h-10" />
